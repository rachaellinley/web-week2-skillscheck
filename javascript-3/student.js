...
//that takes care of some of the work for 
...
//////////////////STEP 5////////////////////
//Create a function called 'removeItem' that takes in one parameter called 'index'. Inside of the removeItem 
//function,
// remove the item that corresponds to the index parameter from the groceries array above by using splice. 
...
//If the amount of groceries is between 1 and 5, return the string 'NUMBEROFGROCERIES items' with NUMBEROFGROCERIES replaced 
//by the number of items in your groceries array.
...
//         return "NUMBEROFGROCERIES items + NUMBEROFGROCERIES replaced"
//     }
// }
...
//but you should now be able to add items to your grocery list with a dynamic total showing. If you double click on an item, 
